...
class UserManager(BaseUserManager):
    def email_validator(self,email):
        try:
            ...
            raise ValueError(_("please enter the valid email"))
    ...
    def create_user(self,email,first_name,last_name,password,**extra_fields):
        if email:
            ...
            raise ValueError(_("email fields is required"))
    ...
    def create_superuser(self,email,first_name,last_name,**extra_fields):
        ...
        user=self.create_user(email,first_name,last_name,**extra_fields)
        user.save(using=self.db)
        return user                
